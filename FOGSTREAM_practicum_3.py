...
с с гипотенузой, ограниченной точками (x1,y1) и (x2,y2). Катеты параллельны осям.
Точка пересечения катетов лежит ниже гипотенузы. Площадь округляйте до сотых."""
...
def area(x1, x2, y1, y2):
    return round(math.fabs((x2 - x1) * (y2 - y1) / 2), 2)
